file_location = "languages_projects/brain_f/brainf.text"
# file_location = "languages_projects/brain_f/brain_f_code/greater_than"

program_file = open(file_location, "r")
code_lines = program_file.readlines()
program_file.close()

program_file = open("languages_projects/brain_f/input.text", "r")
input_text = list("".join(program_file.readlines()))
program_file.close()

program_string = list("".join(code_lines))
